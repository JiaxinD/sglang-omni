...
def test_dots_tts_shares_acoustic_limits_via_shared() -> None:
    """One shared entry feeds the solver settings to both consumers."""
    from sglang_omni.models.dots_tts.config import DotsTTSPipelineConfig
